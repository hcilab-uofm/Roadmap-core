...
namespace ubco.hcilab
{
    ...
    public class GeospatialManager : Singleton<GeospatialManager>
    {
        ...
        [SerializeField] private float _minimumHorizontalAccuracy = 10;//10
        [SerializeField] private float _minimumHeadingAccuracy = 50;//15
        [SerializeField] private float _minimumVerticalAccuracy = 10.5f;//1.5f

        [Header("[ Accuracy Targets ] - Event raised when reached")]
        [SerializeField] private float _targetHorizontalAccuracy = 1;//1
        [SerializeField] private float _targetHeadingAccuracy = 2;//2
        [SerializeField] private float _targetVerticalAccuracy = 0.5f;//0.5f
