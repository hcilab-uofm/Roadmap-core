...
namespace ubco.hcilab.roadmap
{
    ...
    public class UI_InfoMenu : MonoBehaviour
    {
        ...
        void OpenGithubLink() {
            //Application.OpenURL(InitManager.Instance.RepoUrl + Application.identifier);
            Application.OpenURL(InitManager.Instance.RepoUrl);
        }

        void OpenLearnMoreLink()
        {
            //Application.OpenURL(InitManager.Instance.LearnMoreUrl + Application.identifier);
            Application.OpenURL(InitManager.Instance.LearnMoreUrl);
        }
