...
namespace ubco.hcilab.roadmap
{
    public class UI_PlantingFirstRun : MonoBehaviour
    {
        ...
        void Run(List<PlaceablesGroup> groups)
        {
            ...
            if (InitManager.Instance.CurrentAppState == AppState.Splash)
            {
        ...
        {
            InitManager.Instance.AppStateChanged.RemoveListener(OnAppStateChanged);
        ...
        IEnumerator LetsStartGardening()
        {
            ...
            SetTapToPreview(InitManager.Instance.CurrentAppState);
        }
        ...
        void SetTapToPreview(AppState appState)
        {
            ...
            InitManager.Instance.AppStateChanged.AddListener(WaitForConfirmation);
        ...
        void WaitForConfirmation(AppState appState)
        {
            ...
            tapToPreviewUI.SetActive(false);
            InitManager.Instance.AppStateChanged.RemoveListener(WaitForConfirmation);
