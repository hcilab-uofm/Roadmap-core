        ...
        private void UpdateStatus()
        {
            if (GeospatialManager.Instance.IsTracking)
            {
                Set(GeospatialManager.Instance.EarthManager.EarthTrackingState.ToString() + " [Peak]" +
                    ...
                    " | V: " + GeospatialManager.Instance.BestVerticalAccuracy.ToString("F1") +
                    " | Head: " + GeospatialManager.Instance.BestHeadingAccuracy.ToString("F1"));
            }
            else
            {
                Set(GeospatialManager.Instance.EarthManager.EarthTrackingState.ToString() + " [Current]" +
                    ...
                    " | V: " + GeospatialManager.Instance.EarthManager.CameraGeospatialPose.VerticalAccuracy.ToString("F1") +
                    " | Head: " + GeospatialManager.Instance.EarthManager.CameraGeospatialPose.HeadingAccuracy.ToString("F1") );
            }
        }
