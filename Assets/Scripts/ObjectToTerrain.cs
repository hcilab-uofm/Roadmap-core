...
namespace ubco.hcilab.roadmap {
    ...
    public class ObjectToTerrain : EditorWindow {
        ...
        EditorWindow.GetWindow<ObjectToTerrain>(true);
        }

        private string outFileName = "MyTerrainData";
        ...
        void OnGUI () {
            ...
            // outFileName = EditorGUILayout.TextField("Out File Name", "MyTerrainData");
        ...
        void CreateTerrain(){	
            ...
            AssetDatabase.CreateAsset(terrain, $"Assets/{outFileName}.asset");
