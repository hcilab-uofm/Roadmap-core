...
{
    // TODO: what purpose does this class serve?
    public class InitManager : Singleton<InitManager>
    {
        ...
        public string RepoUrl = "https://github.com/hcilab-uofm/Roadmap";
        ...
        private AppState _defaultAppState = AppState.Placing;
        ...
        private void Start()
        {
            ...
            /// Set the PlaceablesManager prefabs list to model prefabs
            // PlaceablesManager.Instance.PrefabsList = ModelPrefabs;
        ...
        {
            //if (!PlayerPrefs.HasKey("Inventory")) ResetInventory();
        ...
        {
            // RemoveSeedFromInventory(PlaceablesManager.Instance.CurrentPrefabIdentifier);
        }
    }
