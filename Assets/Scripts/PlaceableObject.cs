...
namespace ubco.hcilab.roadmap
{
    ...
    public class PlaceableObject : MonoBehaviour
    {
        ...
        /// </summary>
        public virtual void Init(string prefabIdentifier)
        {
            _placeableData = new PlaceableObjectData(prefabIdentifier, new Pose());
        ...
        /// <summary>
        /// Set the modifications options (TapToPalce, BoundsControle)to `active`.
        /// </summary>
        public virtual void ModifcationActive(bool active)
        {
        ...
        protected virtual void SnapToARPlane()
        {
            ...
            if (Physics.Raycast(transform.position + new Vector3(0f, _raycastFromY, 0f), Vector3.down, out hit, Mathf.Infinity, InteractionManager.Instance.PlanesLayerMask))
            {
                // TODO: How do I handle this?
                // For now assuming the returned hit is only from the InteractionManager.Instance.PlanesLayerMask. It is expected to have a ARPlane or something related.
